...
public class ButterflySwarmController : MonoBehaviour
{
    ...
    [Range(0f, 1f)] public float startAtCalmness = 0.85f; // start showing
    [Range(0f, 1f)] public float fullAtCalmness = 1.0f;   // fully shown
    ...
    [Header("Motion")]
    public float orbitSpeed = 0.7f;     // overall speed
    public float turnSpeed = 6.0f;      // how quickly they face direction
    public float bobAmount = 0.12f;     // vertical bob
    public float driftAmount = 0.35f;   // sideways drift (adds “alive” motion)

    [Header("Performance / Behaviour")]
    public bool spawnOnce = true;
    public bool keepSwarmNearThisObject = true; // if you move this object, butterflies follow
    ...
    private void Update()
    {
        ...
        // Spawn when calmness reaches threshold
        ...
        // If you want them to disappear again when calmness drops, remove spawnOnce and add hide logic.
        // For your project, spawning once near full calmness usually feels best.

        // Drive visibility by scaling (simple, works with any materials)
    ...
    private void Spawn()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            // start hidden; will be enabled by visibility logic
            b.SetActive(false);
        }
    }
    ...
    private Vector3 GetTargetPosition(int i, float t)
    {
        ...
        // drift using perlin (makes motion feel organic)
